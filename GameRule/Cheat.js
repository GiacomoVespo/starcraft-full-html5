    ...
    execute:function(cheatCode){
        ...
        switch (cheatCode){
            case "show me the money":
                ...
                break;
				case "show me the premium":
                Resource[Game.team].mine+=100;
                Resource[Game.team].gas+=100;
                break;
			case "show monster money":
                Resource[Game.team].mine+=50000;
                Resource[Game.team].gas+=50000;
                break;	
